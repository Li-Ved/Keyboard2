...
void train(Profile *profile, int intro_variant)
{
    ...
    if (choice == 1)
    {
        ...
        {
        case 1:
            text = fopen("data/sent1.txt", "r");
            break;
        case 2:
            text = fopen("data/sent2.txt", "r");
            break;
        }
    }
    if (choice == 2)
    {
        ...
        {
        case 1:
            text = fopen("data/wor1.txt", "r");
            break;
        case 2:
            text = fopen("data/wor2.txt", "r");
            break;
        }
    }
    if (choice == 3)
    {
        ...
        {
        case 1:
            text = fopen("data/let1.txt", "r");
            break;
        case 2:
            text = fopen("data/let2.txt", "r");
            break;
        }
    }
    check_text(text);
